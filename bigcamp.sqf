...
_vehpos = [(_pos select 0)+50-random 100,(_pos select 1)+50-random 100,0] findemptyposition [1,30,"I_HMG_01_high_F"];
...
_vehpos2 = [(_pos select 0)+50-random 100,(_pos select 1)+50-random 100,0] findemptyposition [1,30,"I_HMG_01_high_F"];
_gun2 = [_vehpos2,((_vehpos2 select 0)-(getPos _camp select 0)) atan2 ((_vehpos2 select 1)-(getPos _camp select 1)),"Gunbag"] call CSAR_fnc_CampGun;
