...
// Filter out occupied statics ** Changed to BIS_fnc_SortBy because fnc_filter was returning [true,true,true,true] instead of objects
//[_statics,{(_x emptyPositions "Gunner") > 0},true] call CBA_fnc_filter;
_statics = [_statics,[],{_position distance _x},"ASCEND",{(_x emptyPositions "Gunner") > 0}] call BIS_fnc_sortBy;
