...
_pos = getpos _camp;
_vehpos = [(_pos select 0)+25-random 50,(_pos select 1)+25-random 50,0];// findemptyposition [1,15,_vehtype];
_gunpos = [(_pos select 0)+50-random 100,(_pos select 1)+50-random 100,0];// findemptyposition [1,15,"I_HMG_01_high_F"];
sleep 0.5;
