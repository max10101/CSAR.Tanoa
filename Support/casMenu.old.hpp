class casMenu
{
	...
	class btnRequest: JWC_Button
		...
		idc = 100112;
		text = "Request CAS";
		action = "CASRequest = true; CASAbort = false; publicVariable ""CASAbort""; closeDialog 0";
		y = 0.619;
		x = 0.006;
		w = 0.178;
		h = 0.090;
	...
	class btnCancel: JWC_Button
		...
		idc = 100113;
		text = "Cancel CAS";
		action = "CASAbort = true; publicVariable ""CASAbort""; CASInProgress = false; publicVariable ""CASInProgress""; closeDialog 0";
		y = 0.619;
		x = 0.156;
		w = 0.178;
		h = 0.090;
	...
	class Checkbox : JWC_CheckBox
	{
		...
		rows = 1;
		columns = 3;
		strings[] = {"JDAM","CBU(AP)","CAS"};
		checked_strings[] = {"JDAM","CBU(AP)","CAS"};
       	        onCheckBoxesSelChanged = "if (_this select 1 == 0) then {CASType = 'JDAM'}; if (_this select 1 == 1) then {CASType = 'CBU'}; if (_this select 1 == 2) then {CASType = 'CAS'}";
	};
